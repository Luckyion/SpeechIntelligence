...
public class IseDemo extends Activity implements OnClickListener {
	...
	private void setParams() {
		...
		mSpeechEvaluator.setParameter(SpeechConstant.ISE_AUDIO_PATH, Environment.getExternalStorageDirectory()
				.getAbsolutePath() + "/msc/" + language + "_" + category + "_" + System.currentTimeMillis()/1000 + ".pcm");
	}
