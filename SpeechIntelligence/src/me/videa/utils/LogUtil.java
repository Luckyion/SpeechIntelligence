...
public class LogUtil {  
    ...
    private static String MYLOGFILEName = "Glxs_Loction_Log.txt";// 本类输出的日志文件名称  
  ...
  public static void initLogPath(){
	  MYLOG_PATH_SDCARD_DIR=getMYLOG_PATH_SDCARD_DIR();
  ...
  public static void initLogPath(String path){
   ...
   public static String getMYLOG_PATH_SDCARD_DIR(){
	   return getSDPath()+"/nari/logs/";
   }
}  